...
//	}
	 ...
	 * textbox Arguments : obj-->object textval--->to be entered objName--->object
	 * name createdby : Automation team created date :02/13/19 LastModified
	 * Date:02/13/19
	 */
	...
	/*
	 * name of the method: clickobject--->Button BriefDescription : clicking a
	 * button Arguments : obj-->object,objName--->object name createdby : Automation
	 * team created date :02/13/19 LastModified Date:02/13/19
	 */
	...
	/*
	 * Name of the method: selectCheckBox Brief Description: Select the checkbox
...
//				
	...
	/*
	 * Name of the method: validateErrormsg Brief Description: to validate the error
	 * msg Arguments: actualmsg --> name of the object, errormsg--> name of the
	 * object Created by: Automation team Creation Date: Feb 12 2019 Last Modified:
	 * Feb 12 2019
	 */
...
//		logger.log(LogStatus.FAIL,  "TestCase is failed" );
	...
	/*
	 * name of the method: iFrame BriefDescription : iframe using webelement
	 * Arguments : driver--->driver obj--->webelement createdby : Automation team
...
//     logger.log(LogStatus.PASS,  "we can switch to the frame" );
	...
	/*
	 * name of the method: switchdefaultFrame BriefDescription : iframe for
	 * switching back to default frame Arguments : driver--->driver createdby :
	 * Automation team created date :02/13/19 LastModified Date:02/13/19
	 */
...
//logger.log(LogStatus.PASS,  "we can switch back to the frame" );
	...
	/*
	 * name of the method: mouseOver BriefDescription : mouseOver Arguments :
	 * obj,index createdby : Automation team created date :02/13/19 LastModified
	 * Date:02/13/19
	 */
...
//		logger.log(LogStatus.FAIL,  "obj is not present.Please chk application" );
	...
	/*
	 * name of the method: selectbyText BriefDescription : selected by clicking the
	 * dropdown Arguments : obj,objName createdby : Automation team created date
	 * :02/13/19 LastModified Date:02/13/19
	 */
...
//	    logger.log(LogStatus.FAIL, " is not Selected by VisibleText" );
	...
	/*
	 * name of the method: SelectByValue BriefDescription : selectedByValue by
	 * clicking the dropdown Arguments : obj,index createdby : Automation team
	 * created date :02/13/19 LastModified Date:02/13/19
	 */
...
//	   logger.log(LogStatus.FAIL, " is not selected from drop down " );
	...
	/*
	 * name of the method: SelectByindex BriefDescription : selected by clicking the
	 * dropdown Arguments : obj,index createdby : Automation team created date
	 * :02/13/19 LastModified Date:02/13/19
	 */
...
//	   logger.log(LogStatus.FAIL, " is not selected from drop down " );
	...
	/*
	 * Name of the method: Radiobutton Brief Description: To click on the radio
	 * button Arguments: obj --> web object, objName--> name of the object Created
	 * by: Automation team Creation Date: Feb 12 2019 Last Modified: Feb 12 2019
	 */
	...
	/*
	 * name of the method: switchtoAlert BriefDescription : Switch to alert
	 * Arguments : driver createdby : Automation team created date :02/13/19
...
//	public void webTable(WebElement table) {
//		List<WebElement> rowsNumber = (List<WebElement>) table;
//				//driver.findElements(By.xpath("//*[@id="content-8b4988b9-2ec9-4e77-9b4d-9c2994bd9e8a"]/div/div/table[1]/tbody/tr[1]/td[1]"));
